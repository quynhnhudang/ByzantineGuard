...
def args_parser():
    ...
    parser.add_argument('--l2_lambda', type=float, default=0, help="SGD l2 regularization (default: 0.992)")
    ...
    parser.add_argument('--adv_eps', type=float, default=0.031, help="adversarial perturbation")
    ...
    parser.add_argument('--sl_tau', type=float, default=0.44, help="perturbation level")
    parser.add_argument('--sl_alpha', type=float, default=0.15, help="soft label value for adv train examples")
